...
export class AppointmentCreateComponent implements OnInit 
{
  ...
  private initializeForm(): void {
    this.appointmentForm = this.fb.group({
      appointmentId: ['', [Validators.required, this.positiveIntegerValidator]],
      patientId: ['', [Validators.required, this.positiveIntegerValidator]],
      clinicId: ['', [Validators.required, this.positiveIntegerValidator]],
  ...
  onSubmit(): void {
    ...
    const appointmentData = this.appointmentForm.value;
    console.log('Appointment Data:', appointmentData);
    this.successMessage = `Appointment created successfully! Appointment ID: ${appointmentData.appointmentId}`;
